...
const rawAgents = [
    ...
    { id: "COO", name: "COO Operations", cat: "conclave", color: "white", isUser: false, img: "/images/conclave_critico_agent_1776437237632.png", faz: "Gestão operacional e sincronia tática entre departamentos.", res: "Garante que a execução siga o Roadmap sem gargalos.", u: "Monitoramento diário da saúde da operação." },

    { id: "mente-maestro", name: "Mente Maestro", cat: "conclave", color: "white", isUser: true, img: "/images/jarvis_master_nucleus_1776436321136.png", faz: "Orquestração suprema de todos os agentes e decisões do ecossistema.", res: "Centraliza o comando e garante a execução da visão do usuário.", u: "Sempre que precisar de uma visão holística ou comando mestre." },

    // 04 - MENTES CLONADAS (GOLD) - External Experts
    { id: "HORMOZI", name: "Alex Hormozi Clone", cat: "minds", color: "gold", isUser: false, img: "/images/hormozi_clone_agent_1776436596228.png", faz: "Criação de Grand Slam Offers e ofertas irrecusáveis de $100M.", res: "Transforma produtos 'commodities' em desejos vorazes impossíveis de ignorar.", u: "Desenho da oferta principal e estruturação de Bumps/Upsells." },
    { id: "BRUNSON", name: "Russell Brunson Clone", cat: "minds", color: "gold", isUser: false, img: "/images/brunson_clone_agent_1776436612466.png", faz: "Arquitetura de Funis de Vendas Complexos e Escada de Valor.", res: "Maximiza o LTV (valor vitalício) extraindo o máximo de cada lead no ecossistema.", u: "Desenho da jornada do cliente da Isca Digital até o High-Ticket." },
    { id: "COLE-G", name: "Cole Gordon Master", cat: "minds", color: "gold", isUser: false, img: "/images/vigia_metrics_traffic_agent_1776436674655.png", faz: "Estratégia de Inbound Sales e treinamento de Closers de elite.", res: "Aumenta drasticamente a taxa de conversão em vendas de alto ticket.", u: "Otimização de processos de vendas por WhatsApp ou telefone." },
    { id: "MINER", name: "Jeremy Miner (NEPQ)", cat: "minds", color: "gold", isUser: false, img: "/images/simon_similarweb_spy_1776436421734.png", faz: "Psicologia de vendas reversa via perguntas NEPQ (Neuro-Emotional).", res: "Elimina a resistência de compra natural do ser humano sem parecer vendedor.", u: "Criação de scripts de vendas e quebra de objeções impossíveis." },
    { id: "HAYNES", name: "Jeremy Haynes Guru", cat: "minds", color: "gold", isUser: false, img: "/images/architect_core_sys_agent_1776436691571.png", faz: "Posicionamento de Agência e Branding de Autoridade Mundial.", res: "Cria uma percepção de valor tão alta que o preço se torna irrelevante.", u: "Branding pessoal e estratégias de escala de agências digitais." },
    ...
    { id: "ESTRATEGI", name: "Estrategista Master", cat: "pro", color: "blue", isUser: false, img: "/images/conclave_critico_agent_1776437237632.png", faz: "Define o ângulo estratégico central da operação e metas financeiras.", res: "Garante o direcionamento cirúrgico de todas as áreas.", u: "No início absoluto de qualquer projeto Supremo." },
