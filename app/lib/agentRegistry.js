...
const rawAgents = [
    ...
    { id: "mente-maestro", name: "Mente Maestro", cat: "sys", color: "cyan", isUser: true, img: "/images/jarvis_master_nucleus_1776436321136.png", faz: "Orquestração suprema de todos os agentes e decisões do ecossistema.", res: "Centraliza o comando e garante a execução da visão do usuário.", u: "Sempre que precisar de uma visão holística ou comando mestre." },
    { id: "COO", name: "COO Operations", cat: "sys", color: "white", isUser: false, img: "/images/conclave_critico_agent_1776437237632.png", faz: "Gestão operacional e sincronia tática entre departamentos.", res: "Garante que a execução siga o Roadmap sem gargalos.", u: "Monitoramento diário da saúde da operação." },
